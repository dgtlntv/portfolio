...
export default function MetricsMockup({ className = "" }: MetricsMockupProps) {
    ...
    return (
        <div
            className={`not-prose min-w-[24rem] -rotate-2 rounded-lg border border-gray-200 bg-white p-4 shadow-sm ${className}`}
        >
                    ...
                    >
                        <div className="grid h-full grid-cols-2">
                            ...
                            <div className="flex flex-col justify-center space-y-2 p-4">
                                <span className="text-[10px] leading-relaxed font-medium tracking-wide text-gray-600 uppercase">
                                    {metric.title}
                                </span>
                                <div className="text-xl leading-normal font-bold text-gray-900">
                                    {metric.value}
                                </div>
