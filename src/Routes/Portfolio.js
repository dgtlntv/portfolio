...
export default function Portfolio() {
    return (
        <div className="py-16 overflow-hidden lg:py-12">
            <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0 lg:max-w-5xl mx-auto lg:px-8">
                <div className="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
                    <img className="object-cover shadow-lg rounded-lg" src="/profile_pic.jpg" alt="" />
                </div>
                <div className="sm:col-span-2">
                    <div className="space-y-4">
                        <div className="text-2xl leading-6 font-medium space-y-1">
                            <h3 className="font-bold">Maximilian Blazek</h3>
