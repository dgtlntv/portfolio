        ...
        <Article stats={stats} title="Portfolio Cover" heroLocation="center" heroUrl="https://res.cloudinary.com/drsfxkvt1/image/upload/v1659639674/portfolio/portfolio%20cover/Hero_f4prxt.png">
            <ArticleTextWrapper>
                ...
                <p>
                    ...
                    off-the-shelf controls that come with Three.js can only control the camera, but not the 3D models. So I had to program them myself. The ability to rotate the 3D model with the
                    mouse was not that hard. I just had to map the x and y coordinates of the mouse to the x and y rotation of the 3D models.
                </p>
                <CodeBlock code={MouseCoordinatesCode} />

                <p>
                    The more difficult problem was mapping the rotation of the cell phones to the rotation of the 3D models. The problem was that the Web Api, which is supported by all major browsers,
                    returns the cell phone rotation data in{" "}
                    ...
                    . In terms of the web API, this means that for certain rotations of the mobile device, the returned values jump around. This proved problematic because it meant that if I mapped
                    the rotation of the mobile device directly to the 3D model, it would also jump around. Which was aesthetically not acceptable. I had to struggle with this problem for quite some
                    time. The solution I found in the end is a competing web API that outputs the rotations in{" "}
