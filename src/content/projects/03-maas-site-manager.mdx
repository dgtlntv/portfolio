...
process:
    ...
    - id: geographic
      label: Scoping the feature
      anchor: geographic-visualization-challenge
    - id: design-process
      label: Exploring solutions
      anchor: design-process-and-constraints
    - id: roadblock
      label: Hitting a wall
      anchor: technical-roadblock-and-alternative-solution
      style:
          loop: true
    - id: alternative
