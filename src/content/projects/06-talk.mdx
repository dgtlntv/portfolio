...
coverImage: "/images/projects/talk/talk-hero-image.webp"
heroAltText: "A photo showing a person presenting in front of a screen."
heroLocation: "cover"
stats:
    [
...
<AnimatedImage src="/images/projects/talk/nasa-presentation.webp" alt="NASA PowerPoint slide from Columbia accident investigation showing complex risk assessment data in poorly formatted bullet points, demonstrating ineffective presentation design that contributed to communication failures" rotationDirection="left" slot="content" />
  <figcaption slot="content">
...
<FloatContent position="left">
  <TalkExplanationAnimation slot="content" />
  <figcaption slot="content">
...
- Eliminated the need to manually create slide layouts, preventing common issues
  like overcrowded slides with excessive bullet points
