...
Project Background I was tasked with developing a map feature for MAAS Site
Manager, based on earlier user research that identified location information as
valuable context. Users needed to know where in the world their data centers and
sites were located to effectively manage their infrastructure. For example, when
