...
<div className="grid grid-cols-3 gap-4 -mx-28 my-8">
  <div className="col-span-3">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img1.jpg" alt="Blockchain application screenshot" />
  </div>

  <div className="col-span-1">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img2.jpg" alt="Blockchain application screenshot" />
  </div>

  <div className="col-span-1">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img3.jpg" alt="Blockchain application screenshot" />
  </div>

  <div className="col-span-1">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img4.jpg" alt="Blockchain application screenshot" />
  </div>

  <div className="col-span-3">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img5.jpg" alt="Blockchain application screenshot" />
  </div>

  <div className="col-span-3">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img6.jpg" alt="Blockchain application screenshot" />
  </div>

  <div className="col-span-1">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img7.jpg" alt="Blockchain application screenshot" />
  </div>

  <div className="col-span-1">
    <img className="w-full h-auto rounded-lg" src="/images/blog/jargon/img8.png" alt="Blockchain application screenshot" />
  </div>
</div>
