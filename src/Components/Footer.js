        ...
        <footer id="footer" className="bg-white">
            <div className="max-w-5xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
                <div className="flex justify-center space-x-4 md:order-2">
                    <a href="https://www.linkedin.com/in/maxblazek/" className="text-gray-400 hover:text-gray-500 flex flex-col justify-center">
                ...
                <div className="mt-8 md:mt-0 md:order-1">
                    <p className="text-center text-base text-gray-400">2022 Maximilian Blazek</p>
                </div>
            </div>
        </footer>
    )
